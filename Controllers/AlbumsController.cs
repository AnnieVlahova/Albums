...
namespace Albums.Controllers
{
    public class AlbumsController : Controller
    {
        ...
        // GET: Albums/ShowSearchForm
        public async Task<IActionResult> ShowSearchForm()
        {
            return View();
        }

        // POST: Albums/ShowSearchForm
        public async Task<IActionResult> ShowSearchResults(string SearchPhrase)
        {
            return _context.Albums != null ?
                          View("Index", await _context.Albums.Where(a => a.Title.Contains(SearchPhrase)).ToListAsync()) :
                          Problem("Entity set 'AppDbContext.Album'  is null.");
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Released,AlbumPictureURL,Description,Price")] Album album)
        {
            if (id != album.Id)
            {
                return NotFound();
