...
namespace Albums.Controllers
{
    public class ProducersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,PictureURL,FullName,BirthDate,Bio")] Producer producer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,PictureURL,FullName,BirthDate,Bio")] Producer producer)
        {
            if (id != producer.Id)
            {
                return NotFound();
