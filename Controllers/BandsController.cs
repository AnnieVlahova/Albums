    ...
    public class BandsController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Bands != null ? 
                          ...
                          Problem("Entity set 'AppDbContext.Bands'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Bio,Created")] Band band)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Bio,Created")] Band band)
        {
            if (id != band.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'AppDbContext.Bands'  is null.");
            }
            var band = await _context.Bands.FindAsync(id);
            if (band != null)
            {
